...
# import matplotlib.pyplot as plt
# n_, s_, p_ = 10000, 10, 500

# results_plot = []
# std_plot = []
# n_seq = [7500, 10000, 12500, 15000]
# for n_ in n_seq:
#   errors_load = np.loadtxt(f"results/L2err_n={n_}_s={s_}_p={p_}.txt")
...
# plt.plot(n_seq, results_plot[:, 0], label="Ave-DC-pf")
# plt.plot(n_seq, results_plot[:, 1], label="mSMSE-hd")
# plt.plot(n_seq, results_plot[:, 2], label="pooled-pf")
